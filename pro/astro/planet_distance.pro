function planet_distance, date, planet=planet, jd = jd, jpl = jpl
;+
; NAME:
;    PLANET_DISTANCE (based on astrolib PLANET_COORDS)
;    e.g. print,planet_distance(2450001.,planet='JUPITER',/jd,/jpl)
; PURPOSE:  
;    Find distance between Earth and the planets (km).
;
; EXPLANATION:
...
;       ra[i] = atan(y,x) * radeg   ;SML seems buggy for the case with
;       several dates and one planet.
;       g = where(ra LT 0, Ng)

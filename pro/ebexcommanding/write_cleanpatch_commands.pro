PRO write_cleanpatch_commands,reference_date,mission

 ; Author: S. Leach
 ; Purpose: Generates schedule files for scanning clean patches of sky.
  ...
  lon = mission.longitude_start_deg
  
  ;Scanning parameters for CMB scan
  nelevationsteps    = 90  
  scanspeed          = 1.  ; deg/s
  scanwidth          = 7.  ; deg
  numstarcam         = 5
  ...
  asc_read,!HEXSKYROOT+'/schedulefiles/na_rise_set.txt',day_num,sun_rise,sun_set,$
	    moon_rise,moon_set,saturn_r_20,saturn_r_60,saturn_s_60,saturn_s_20,$
	    jupiter_r_20,jupiter_s_20,dark_night,$
